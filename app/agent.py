...
def handle_inbound(db, contact: Contact, text: str, telnyx_id: str | None = None) -> None:
    db.add(Message(contact_id=contact.id, direction="in", body=text, telnyx_id=telnyx_id, status="received"))
